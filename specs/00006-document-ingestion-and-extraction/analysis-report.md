...
| A-11 | Coverage | MEDIUM | `tasks.md` T009 | Authors revision `0400` with no edge to T003, which claims the block. Per AD-013 a `04xx` revision before the claim turns CI red three ways | Add `after:T003` |
