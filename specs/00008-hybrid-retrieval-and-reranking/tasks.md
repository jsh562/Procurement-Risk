...
- [ ] T003 {FR-044} Confirm project-instructions.md §Source Code Layout excepts a shared inference runtime — the clause ADR-0023 contradicts — and cite the revision in plan.md item 3 (SC-015)
- [ ] T004 {FR-045} Confirm specs/sad.md's ADR catalog carries the ADR-0023 row appended after ADR-0021 and cite the revision in plan.md §Pending Amendments item 4 (SC-015)
