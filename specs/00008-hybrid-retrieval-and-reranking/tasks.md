...
- [ ] T051 [US1] {FR-043} [COMPLETES FR-043] Perturb a copy of the committed set and assert the harness exits non-zero before any measurement, and that a re-tune publishes the before and after figures together, in src/api/tests/retrieval/test_evaluation_set.py after:T050
