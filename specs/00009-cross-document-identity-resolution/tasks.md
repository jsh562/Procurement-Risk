...
- [ ] T016 {FR-025,FR-038,FR-046} Author revision 0508_resolution_figure — resolution_figure, its 8-name figure domain, the no-interval-reason domain, stratum, census and shortfall CHECKs after:T015
...
- [ ] T064 [US3] {FR-025,FR-029,FR-038} [COMPLETES FR-038] Write the 6 resolver figure rows with an interval or a declared no-interval reason, coverage beside precision, in identity/report.py after:T062
...
- [ ] T066 [US3] {FR-046} [COMPLETES FR-046] Write baseline_merge_precision and baseline_recall as figure rows and render them beside the resolver's, labeled strong, in identity/report.py after:T063
