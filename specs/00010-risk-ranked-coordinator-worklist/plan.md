...
| Line population | The E005 seeded set — ~200 open lines across 5 projects — with a posterior per covered line at `draw_count` 4000 and `horizon_days` 365 |
