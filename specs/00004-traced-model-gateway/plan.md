...
| IP-002 | E001 Compose `db` service | Revisions in the `0100`–`0199` prefix block applied by E003's runner in `/src/model` ({SAD:ADR-0013}); new CI job carries the same service | `data-model.md` |
